...
namespace Pemrograman_1214078.model
{
    ...
    {
        string nama_customer, nomor_ktp, alamat, merk_motor, nomor_hp, tanggal_pembelian;
        ...
        public M_DataCustomer(string nama_customer, string nomor_ktp, string alamat, string merk_motor, string nomor_hp, string tanggal_pembelian)
        {
        ...
        public string Merk_motor { get => merk_motor; set => merk_motor = value; }
